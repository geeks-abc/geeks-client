...
const s = StyleSheet.create({
  ...
  profileLabel: { fontSize: 11, color: C.sub, fontWeight: '600' },
  profileName: { fontSize: 16, fontWeight: '800', color: C.text },
  locationLabel: { fontSize: 11, color: C.sub, fontWeight: '600' },
  locationValue: { fontSize: 14, fontWeight: '700', color: C.text, marginTop: 2 },
  feedMeta: { fontSize: 12, color: C.sub, marginTop: -8 },
  thumb: {
    width: 56,
    height: 56,
    borderRadius: 14,
  ...
  thumbText: { fontSize: 9, fontWeight: '900', color: C.navy },
  storeName: { fontSize: 12, color: C.sub, fontWeight: '600' },
  itemName: { fontSize: 16, fontWeight: '800', color: C.text },
  itemMeta: { fontSize: 12, color: C.sub },
  urgent: { backgroundColor: C.redSoft, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 },
  urgentText: { fontSize: 11, fontWeight: '800', color: C.red },
  timeChip: {
  ...
  timeChipText: { fontWeight: '800', color: C.navy, fontSize: 13 },
});
